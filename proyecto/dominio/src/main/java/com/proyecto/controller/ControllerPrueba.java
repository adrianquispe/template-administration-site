...
public class ControllerPrueba {
  ...
  public String probandoRedir(Model modelo,
                              @RequestParam(name = "idReserva", required = false) String idReserva){
    System.out.println(idReserva);

    if(idReserva == null){
      modelo.addAttribute("valor", "no existe el valor buscado");
      return "prueba_redir";
    }
